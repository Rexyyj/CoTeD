...
class Manager():
    ...
    def update_requirements(self,tolerable_mAP_drop, target_latency,available_bandwidth, f_index): # [%, bps]
        ...
        if f_index >= len(self.test_points):
            ...
            jpeg_transmission_time =  target_latency - 0.100 - 0.005 -0.005
            decom_transmission_time = target_latency - 0.100 - 0.005 -  0.14
            reg_transmission_time = target_latency - 0.100 - 0.005 -0.145
            # jpeg optimization
